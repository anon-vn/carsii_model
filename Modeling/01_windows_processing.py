...
if __name__ == "__main__":
    ...
    with open('Dataset/data_all/param.pkl', 'wb') as f:
    ...
    data_train.to_csv("Dataset/data_all/train.csv", index=False)
    data_test.to_csv("Dataset/data_all/test.csv", index=False)
